...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ route('contacts.index') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">all
                contacts</a>
            <a href="{{ route('contacts.create') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">add
                contact</a>
            <a href="{{ route('contacts.show', 1) }}" class="text-sm text-gray-700 dark:text-gray-500 underline">show
                contact</a>
